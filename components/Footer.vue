<template lang="pug">
.w-full.min-h-64.bg-black.rounded-b-sm.justify-between.items-center.p-10.fixed.bottom-0.text-white.font-light
  .grid.grid-cols-6.gap-6
    ...
    .flex.flex-col
      ...
      .cursor-pointer.flex.items-center(v-for="item in contactItems")
        Icon.w-4.h-4.mr-3(:name="item.icon", color="white")
        p {{ item.text }}
  hr.my-10
...
const products = ["Cleansers", "Serums", "Creams", "Toners"];

const helpSection = ["Shipping and return", "Track order", "FAQ"];
